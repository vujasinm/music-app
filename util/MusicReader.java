        ...
        while (scanner.hasNext()) {
            ...
            switch (lineType) {
                ...
                case "repeat":
                    ...
                    break;
//                case "repeatExt":
//                    RepeatExt newRepeat = new RepeatExt();
//                    try {
//                        int beg = scanner.nextInt();
//                        int end = scanner.nextInt();
//                        newRepeat.addCommonBody(beg, end);
//                        while (!scanner.hasNext("k")) {
//                            int begin = scanner.nextInt();
//                            int ending = scanner.nextInt();
//                            newRepeat.addEnding(begin, ending);
//                        }
//                        piece.addRepeatExt(newRepeat);
//                    }
//                    catch (NoSuchElementException e) {
//                        throw  new IllegalArgumentException("Malformed repeatExt line: " + scanner.nextLine());
//                    }
//                    break;
                case "note":
                    try {
